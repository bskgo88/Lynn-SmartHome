...
class DeviceControlHeaterWidget extends StatefulWidget {
	final UserHomeDevices device;
	const DeviceControlHeaterWidget({Key key, this.device}) : super(key: key);
	@override
	DeviceControlHeaterWidgetState createState() =>  DeviceControlHeaterWidgetState();
}

class DeviceControlHeaterWidgetState extends State < DeviceControlHeaterWidget > {
	...
	Widget build(BuildContext context) {
		...
		deviceTypeCode = widget.device.devicemodel.modeltype.code;
		...
		if (device.currTemperature == null || device.currTemperature == "") {
			device.currTemperature = "22";
		}
		if (device.setTemperature == null || device.setTemperature == "") {
			device.setTemperature = "22";
		}
		//print("_DeviceControlHeaterWidgetState build deviceId : ${device.deviceId} device.currTemperature : ${device.currTemperature}  device.setTemperature : ${device.setTemperature}");
                            ...
                            activeTrackBar: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                begin: Alignment.topLeft,
                                  ...
                                  isPowerOn ? Color.fromARGB(255, 255, 75, 0): Color.fromARGB(255, 100, 100, 100),
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.montserrat(
                            fontWeight: FontWeight.w400,
                            fontSize: 24,
                            color: isPowerOn ? Colors.orange : Colors.grey,  //const Color(0xffff0000)
                          ),
                        )
                      )
                    ],
